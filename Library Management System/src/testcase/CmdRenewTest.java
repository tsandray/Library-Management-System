...
import libCommand.CmdRenewBook;
...
public class CmdRenewTest {
	...
	/* Test case 1: Test renew book with 3 cmdParts
	 * Precondition: 
	 * - Resources in library: [item0]
	 * - Members in library: [mb0]
	 * - item0 is borrowed by mb0
	 * Input: [renew book, 0, 0]
	 */
	@Test
	public void testRenewBook1() throws Exception {
		addResource("item0");
		addMember("mb0");
		...
		new CmdRenewBook().execute(input);;
		
		String expected = "Successfully renewed!\n" + 
				"\n" + 
				"Renew Record\n" + 
				"---------\n" + 
				"TransactionID: 1\n" + 
	...
	// Test case 2: Test renew book with 2 (i.e. insufficient arguments) cmdParts
	@Test
	public void testRenewMember2() throws Exception {
		setOutput();
		String[] input = {"renew book","0"};
		new CmdRenewBook().execute(input);
	...
	// Test case 3: Test renew book with invalid argument
	// Input: ["renew book", "0", "-"]
	@Test
	public void testRenewMember3() throws Exception {
		setOutput();
		String[] input = {"renew book","0", "-"};
		new CmdRenewBook().execute(input);
